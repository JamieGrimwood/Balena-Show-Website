...
# set the hostname to show-website
curl -X PATCH --header "Content-Type:application/json" --data '{"network": {"hostname": "show-website"}}' "$BALENA_SUPERVISOR_ADDRESS/v1/device/host-config?apikey=$BALENA_SUPERVISOR_API_KEY"
